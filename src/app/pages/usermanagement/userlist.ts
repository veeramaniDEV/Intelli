            ...
            <ng-template #header>
                <tr>
                    ...
                    <th pSortableColumn="country.name" class="white-space-nowrap" style="width:23%">
                        <span class="flex items-center gap-2">Country <p-sortIcon field="country.name"></p-sortIcon></span>
                    </th>
                    <th pSortableColumn="date" class="white-space-nowrap" style="width:23%">
                        <span class="flex items-center gap-2">Join Date <p-sortIcon field="date"></p-sortIcon></span>
                    </th>
                    <th pSortableColumn="representative.name" class="white-space-nowrap" style="width:23%">
                        <span class="flex items-center gap-2">Created By <p-sortIcon field="representative.name"></p-sortIcon></span>
                    </th>
                    <th pSortableColumn="activity" class="white-space-nowrap">
                        <span class="flex items-center gap-2">Activity <p-sortIcon field="activity"></p-sortIcon></span>
                    </th>
                </tr>
            </ng-template>
